...
/**
 * StockProduct or item represents the real product in store.
 * 
 * @author odoo Team
 *
 */
public class StockProduct {
	 ...
	 */
	public StockProduct(int id, String name, String barcode, double salePrice) {
		this.id = id;
		this.name = name;
	 ...
	 * @param salePrice price for using when doing sale.
	 */
	public StockProduct(String name, String barcode, double salePrice) {
	...
	/**
	 * Returns the description of this StockProduct in Map format.
	 * @return the description of this StockProduct in Map format.
	 */

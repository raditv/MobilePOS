...
import com.odoo.pos.views.stock.StockFragment;
import com.odoo.pos.views.stock.ProductDetailActivity;
import com.odoo.pos.views.sale.ReportFragment;
import com.odoo.pos.views.sale.SaleFragment;

/**
 * This UI loads 3 main pages (StockServices, Sale, Report)
...
public class MainActivity extends FragmentActivity {
	...
	public void optionOnClickHandler(View view) {
		...
		stockProduct = stockProductCatalog.getProductById(Integer.parseInt(productId));
		openDetailDialog();
	...
	private void openDetailDialog() {
		...
		quitDialog.setTitle(stockProduct.getName());
	...
	private void openRemoveDialog() {
		...
		quitDialog.setNegativeButton(res.getString(R.string.remove), new OnClickListener() {
			...
			@Override
			public void onClick(DialogInterface dialog, int which) {
				stockProductCatalog.suspendProduct(stockProduct);
...
class PagerAdapter extends FragmentStatePagerAdapter {
	...
	public PagerAdapter(FragmentManager fragmentManager, Resources res) {
		...
		UpdatableFragment inventoryFragment = new StockFragment(
				saleFragment);

 ...
 *
 */
public class AndroidDatabaseOperation extends SQLiteOpenHelper implements DatabaseOperation {

	private static final int DATABASE_VERSION = 1;

	/**
	 * Constructs a new AndroidDatabaseOperation.
	 * @param context The current stage of the application.
	 */
	public AndroidDatabaseOperation(Context context) {
	...
	public void onCreate(SQLiteDatabase database) {
		...
		Log.d("CREATE DATABASE", "Create DatabaseOperation Successfully.");
